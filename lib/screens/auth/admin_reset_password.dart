...
// --- DOSYA YOLLARI ---
import '../../providers/auth_provider2.dart'; // AuthProvider'ın olduğu dosya
import 'admin_login.dart'; // İşlem bitince dönülecek Login ekranı
...
class _AdminForgotPasswordWebState extends State<AdminForgotPasswordWeb> {
    ...
    return Column(
      children: [
        ...
        _actionButton("Kod Gönder", () async {
          ...
          // AuthProvider'daki resetPassword fonksiyonunu çağırıyoruz
  ...
  Widget _stepVerifyCode(AuthProvider authProvider) {
    return Column(
      children: [
        const Text("E-postanıza gelen kodu giriniz.", textAlign: TextAlign.center),
        const SizedBox(height: 25),
        _inputField("Doğrulama Kodu", Icons.verified_user_outlined, controller: _codeController),
        const SizedBox(height: 25),
        _actionButton("Kodu Doğrula", () async {
          ...
          // AuthProvider'daki verifyResetCode fonksiyonunu çağırıyoruz
          ...
          if (result != null && result['success'] == true) {
             ...
             // Kod doğruysa Şifre Belirleme Ekranına git
             if (mounted) {
...
class _AdminResetPasswordWebState extends State<AdminResetPasswordWeb> {
  ...
  Future<void> _handleResetPassword() async {
    if (_formKey.currentState!.validate()) {
      ...
      // AuthProvider'daki confirmResetPassword fonksiyonunu çağırıyoruz
