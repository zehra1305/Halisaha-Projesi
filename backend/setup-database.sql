...
CREATE TABLE duyurular (
    id SERIAL PRIMARY KEY,              -- 1. Her duyuruya otomatik numara verir (1, 2, 3..)
    resim_url TEXT NOT NULL,            -- 2. Resmin linkini buraya yazar
    metin TEXT NOT NULL,                -- 3. Yazdığın duyuru metnini buraya yazar
    tarih TIMESTAMP DEFAULT CURRENT_TIMESTAMP -- 4. Paylaşıldığı saati otomatik atar
);
